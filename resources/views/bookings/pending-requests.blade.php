        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-blue-100">Gestiona las solicitudes de reserva de tus servicios</p>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div class="p-6">
                                <div class="flex flex-col lg:flex-row gap-6">
                                    ...
                                    <div class="flex items-start gap-4 flex-1">
                                        @if($booking->client->profile_photo_path)
                                            <img src="{{ $booking->client->profile_photo_path }}" 
                                        ...
                                        <div class="flex-1">
                                            <div class="flex items-center gap-2 mb-2">
                                                <h3 class="text-xl font-bold text-gray-800">{{ $booking->client->name }}</h3>
